...
function loginSuccess() {
    ...
    $("#coursesDim,#year01,#month01,#teachers").change(function () {
        dailyEvaluationTypicalList_port();
    });
    ...
    $("#members").on('click','li >a.membersBg',function () {
        ...
        dailyEvaluationTypicalList_port(childUuid);// 获取课程计划列表
    });
    ...
    var h=$(window).height();
    $("#modal-dialog-qunzu").height(h-200);
...
// 查询接口函数
function dailyEvaluationTypicalList_port(childUuid,pageNumber) {
    var data={
    ...
    initAjax(httpUrl.dailyEvaluationTypicalList,param,dailyEvaluationTypicalList_callback);
};
function dailyEvaluationTypicalList_callback(res) {
    if(res.code==200){
        ...
        $("#pagination").pagination({
            ...
            onPageClick: function (pageNumber, event) {
                dailyEvaluationTypicalList_port($("#dailyEvaluationDelete").attr("data-childid"),pageNumber);
            }
        });
    }else{
...
function dailyEvaluationDelete_callback(res) {
    ...
    dailyEvaluationTypicalList_port($("#dailyEvaluationDelete").attr("data-childid"),pageNumber);// 获取课程计划列表
};
// Row行选择函数
function chooseRow() {
